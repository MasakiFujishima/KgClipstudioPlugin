namespace Loupedeck.KgClipstudioPlugin
{
    ...
    public class 散布効果粒子密度を下げる : PluginDynamicCommand
    {
        public 散布効果粒子密度を下げる()
        : base(displayName: "散布効果 粒子密度を 下げる", description: "散布効果 粒子密度を 下げる", groupName: "ツールプロパティパレット")
        {
        }
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("散布効果 粒子密度を 下げる", color: new BitmapColor(0,0,0));
