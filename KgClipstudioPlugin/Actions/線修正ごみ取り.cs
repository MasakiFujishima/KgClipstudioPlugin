namespace Loupedeck.KgClipstudioPlugin
{
    ...
    public class 線修正ごみ取り : PluginDynamicCommand
    {
        public 線修正ごみ取り()
        : base(displayName: "線修正 ごみ取り", description: "線修正 ごみ取り", groupName: "ツール")
        {
        }
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("線修正 ごみ取り", color: new BitmapColor(241,228,240));
