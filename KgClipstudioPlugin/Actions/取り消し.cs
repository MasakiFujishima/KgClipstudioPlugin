namespace Loupedeck.KgClipstudioPlugin
{
    ...
    public class 取り消し : PluginDynamicCommand
    {
        public 取り消し()
        : base(displayName: "取り消し", description: "取り消し", groupName: "編集メニュー")
        {
        }
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("取り消し", color: new BitmapColor(245,247,229));
