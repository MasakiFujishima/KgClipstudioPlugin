namespace Loupedeck.KgClipstudioPlugin
{
    ...
    public class 選択範囲 : PluginDynamicCommand
    {
        public 選択範囲()
        : base(displayName: "選択範囲", description: "選択範囲", groupName: "ツール")
        {
        }
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("選択範囲", color: new BitmapColor(241,228,240));
