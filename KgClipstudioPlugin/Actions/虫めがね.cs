namespace Loupedeck.KgClipstudioPlugin
{
    ...
    public class 虫めがね : PluginDynamicCommand
    {
        public 虫めがね()
        : base(displayName: "虫めがね", description: "虫めがね", groupName: "ツール")
        {
        }
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("虫めがね", color: new BitmapColor(241,228,240));
