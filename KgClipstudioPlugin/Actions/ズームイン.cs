namespace Loupedeck.KgClipstudioPlugin
{
    ...
    public class ズームイン : PluginDynamicCommand
    {
        public ズームイン()
        : base(displayName: "ズームイン", description: "ズームイン", groupName: "表示メニュー")
        {
        }
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("ズームイン", color: new BitmapColor(37,26,25));
