namespace Loupedeck.KgClipstudioPlugin
{
    ...
    public class テキスト : PluginDynamicCommand
    {
        public テキスト()
        : base(displayName: "テキスト", description: "テキスト", groupName: "ツール")
        {
        }
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("テキスト", color: new BitmapColor(241,228,240));
