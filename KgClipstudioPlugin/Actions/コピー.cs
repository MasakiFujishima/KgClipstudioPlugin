namespace Loupedeck.KgClipstudioPlugin
{
    ...
    public class コピー : PluginDynamicCommand
    {
        public コピー()
        : base(displayName: "コピー", description: "コピー", groupName: "編集メニュー")
        {
        }
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("コピー", color: new BitmapColor(245,247,229));
