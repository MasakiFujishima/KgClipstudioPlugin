namespace Loupedeck.KgClipstudioPlugin
{
    ...
    public class デコレーション : PluginDynamicCommand
    {
        public デコレーション()
        : base(displayName: "デコレーション", description: "デコレーション", groupName: "ツール")
        {
        }
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("デコレーション", color: new BitmapColor(241,228,240));
