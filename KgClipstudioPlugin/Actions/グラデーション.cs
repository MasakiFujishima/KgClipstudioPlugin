namespace Loupedeck.KgClipstudioPlugin
{
    ...
    public class グラデーション : PluginDynamicCommand
    {
        public グラデーション()
        : base(displayName: "グラデーション", description: "グラデーション", groupName: "ツール")
        {
        }
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("グラデーション", color: new BitmapColor(241,228,240));
