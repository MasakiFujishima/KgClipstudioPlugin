namespace Loupedeck.KgClipstudioPlugin
{
    ...
    public class 操作オブジェクト : PluginDynamicCommand
    {
        public 操作オブジェクト()
        : base(displayName: "操作 オブジェクト", description: "操作 オブジェクト", groupName: "ツール")
        {
        }
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("操作 オブジェクト", color: new BitmapColor(241,228,240));
