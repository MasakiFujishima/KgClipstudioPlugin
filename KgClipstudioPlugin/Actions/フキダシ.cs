namespace Loupedeck.KgClipstudioPlugin
{
    ...
    public class フキダシ : PluginDynamicCommand
    {
        public フキダシ()
        : base(displayName: "フキダシ", description: "フキダシ", groupName: "ツール")
        {
        }
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("フキダシ", color: new BitmapColor(241,228,240));
