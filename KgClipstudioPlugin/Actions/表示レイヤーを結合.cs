namespace Loupedeck.KgClipstudioPlugin
{
    ...
    public class 表示レイヤーを結合 : PluginDynamicCommand
    {
        public 表示レイヤーを結合()
        : base(displayName: "表示レイヤー を結合", description: "表示レイヤー を結合", groupName: "レイヤーメニュー")
        {
        }
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("表示レイヤー を結合", color: new BitmapColor(68,13,43));
