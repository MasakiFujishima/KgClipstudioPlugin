namespace Loupedeck.KgClipstudioPlugin
{
    ...
    public class スポイト : PluginDynamicCommand
    {
        public スポイト()
        : base(displayName: "スポイト", description: "スポイト", groupName: "ツール")
        {
        }
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("スポイト", color: new BitmapColor(241,228,240));
