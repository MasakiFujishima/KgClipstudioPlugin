namespace Loupedeck.KgClipstudioPlugin
{
    ...
    public class 貼り付け : PluginDynamicCommand
    {
        public 貼り付け()
        : base(displayName: "貼り付け", description: "貼り付け", groupName: "編集メニュー")
        {
        }
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("貼り付け", color: new BitmapColor(245,247,229));
