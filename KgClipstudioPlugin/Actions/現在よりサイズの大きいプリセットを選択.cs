namespace Loupedeck.KgClipstudioPlugin
{
    ...
    public class 現在よりサイズの大きいプリセットを選択 : PluginDynamicCommand
    {
        public 現在よりサイズの大きいプリセットを選択()
        : base(displayName: "現在より サイズの 大きい プリセットを選択", description: "現在より サイズの 大きい プリセットを選択", groupName: "ブラシサイズパレット")
        {
        }
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("現在より サイズの 大きい プリセットを選択", color: new BitmapColor(0,0,0));
