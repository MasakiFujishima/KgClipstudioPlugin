namespace Loupedeck.KgClipstudioPlugin
{
    ...
    public class 定規にスナップ : PluginDynamicCommand
    {
        public 定規にスナップ()
        : base(displayName: "定規にスナップ", description: "定規にスナップ", groupName: "表示メニュー")
        {
        }
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("定規にスナップ", color: new BitmapColor(37,26,25));
