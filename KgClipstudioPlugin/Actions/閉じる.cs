namespace Loupedeck.KgClipstudioPlugin
{
    ...
    public class 閉じる : PluginDynamicCommand
    {
        public 閉じる()
        : base(displayName: "閉じる", description: "閉じる", groupName: "ファイルメニュー")
        {
        }
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("閉じる", color: new BitmapColor(211,223,242));
