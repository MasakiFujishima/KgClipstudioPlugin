namespace Loupedeck.KgClipstudioPlugin
{
    ...
    public class 特殊定規にスナップ : PluginDynamicCommand
    {
        public 特殊定規にスナップ()
        : base(displayName: "特殊定規に スナップ", description: "特殊定規に スナップ", groupName: "表示メニュー")
        {
        }
        protected override BitmapImage GetCommandImage(String actionParameter, PluginImageSize imageSize)
        {
...

            {
                if (ResourcePath == null)
                {
                    ...
                    bitmapBuilder.DrawText("特殊定規に スナップ", color: new BitmapColor(37,26,25));
